...
if __name__ == "__main__":
    ...
    '''We suggest to develop and test your implementation based on InvertedPendulumBulletEnvv0 
    environment , and then train it on HalfCheetahBulletEnv. For the InvertedPendulum
    environment, you can set the "–max_timesteps=200,000" and for the HalfCheetah, it’s "–
